...
import SOForm from "../../../components/Parts/SupplyOrifices/SOForm";
import SODatabTable from "../../../components/Parts/SupplyOrifices/SODataTable";

const createEquipData = {
  submitBtn: "Add Supply Orifice",
  submittingBtn: "Adding Supply Orifice",
  title: "Add Supply Orifice",
  isEdit: false,
  editId: -1,
};

const editEquipData = {
  submitBtn: "Edit Supply Orifice",
  submittingBtn: "Editing Supply Orifice",
  title: "Edit Supply Orifice",
  isEdit: true,
  editId: 0,
};

const AllSupplyOrifice = () => {
...
export default AllSupplyOrifice;
