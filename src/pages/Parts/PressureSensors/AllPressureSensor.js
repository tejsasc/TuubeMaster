...
import PSForm from "../../../components/Parts/PressureSensors/PSForm";
import PSDatabTable from "../../../components/Parts/PressureSensors/PSDataTable";

const createEquipData = {
  submitBtn: "Add Pressure Sensor",
  submittingBtn: "Adding Pressure Sensor",
  title: "Add Pressure Sensor",
  isEdit: false,
  editId: -1,
};

const editEquipData = {
  submitBtn: "Edit Pressure Sensor",
  submittingBtn: "Editing Pressure Sensor",
  title: "Edit Pressure Sensor",
  isEdit: true,
  editId: 0,
};
function AllPressureSensor() {
...
export default AllPressureSensor;
