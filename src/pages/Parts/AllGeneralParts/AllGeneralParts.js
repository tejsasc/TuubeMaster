...
import AllGeneralPartForm from "../../../components/Parts/AllGeneralParts/AllGeneralPartForm";
import AllGeneralPartDatabTable from "../../../components/Parts/AllGeneralParts/AllGeneralPartDataTable";

const createEquipData = {
  submitBtn: "Add General Part",
  submittingBtn: "Adding General Part",
  title: "Add General Part",
  isEdit: false,
  editId: -1,
};

const editEquipData = {
  submitBtn: "Edit General Part",
  submittingBtn: "Editing General Part",
  title: "Edit General Part",
  isEdit: true,
  editId: 0,
};

const AllGeneralParts = () => {
