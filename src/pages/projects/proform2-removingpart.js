                      ...
                      <Row>
                        <Col sm={2}>
                          <Nav variant="pills" className="flex-column">
                            ...
                            <Nav.Item>
                              <Nav.Link eventKey="pressureSensor">
                                Pressure Sensor
                              </Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
                              <Nav.Link eventKey="supplyOrifice">
                                Supply Orific
                              </Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
                              <Nav.Link eventKey="smTSR">
                                Swab Master TSR
                              </Nav.Link>
                            </Nav.Item>
                          </Nav>
                            ...
                            <Tab.Pane eventKey="pressureSensor">
                              <DragNDrop
                                ...
                                url={
                                  formData.equipPrepDate &&
                                  formData.equipDeliverTM
                                    ? `/get/new/pressuresensor/?start_date=${formData.equipPrepDate}&end_date=${formData.equipDeliverTM}`
                                    : ""
                                }
                                objKey={[
                                  "serial_number",
                                ...
                                epName="pressureSensor"
                                showName="Pressure Sensor"
                                warehouseData={warehouseData}
                              />
                            </Tab.Pane>
                            <Tab.Pane eventKey="supplyOrifice">
                              <DragNDrop
                                title="All Part"
                                selectedVals={[]}
                                ...
                                url={
                                  formData.equipPrepDate &&
                                  formData.equipDeliverTM
                                    ? `/get/new/supplyorifice/?start_date=${formData.equipPrepDate}&end_date=${formData.equipDeliverTM}`
                                    : ""
                                }
                                objKey={[
                                  "serial_number",
                                ...
                                epName="supplyOrific"
                                showName="Supply Orifice"
                                warehouseData={warehouseData}
                              />
                            </Tab.Pane>
                            <Tab.Pane eventKey="smTSR">
                              <DragNDrop
                                title="All Part"
                                selectedVals={[]}
                                ...
                                url={
                                  formData.equipPrepDate &&
                                  formData.equipDeliverTM
                                    ? `/get/new/swabmastertsr/?start_date=${formData.equipPrepDate}&end_date=${formData.equipDeliverTM}`
                                    : ""
                                }
                                objKey={[
                                  "serial_number",
                                ...
                                epName="swabMasterTsr"
                                showName="Swab Master TSR"
                                warehouseData={warehouseData}
                              />
                            </Tab.Pane>
                          </Tab.Content>
