        ...
        <Card.Body>
          ...
          <Form onSubmit="">
            ...
            >
              ...
              <Tab
                eventKey="calibrationstandinfo"
                title="Calibration Stand Info"
              >
              ...
              <Tab eventKey="specification" title="Specification">
                <Form.Group className="mb-3" controlId="formGroupRemark">
                  <Form.Label>Calibration Stand Size</Form.Label>
                  <Form.Control
                    type="text"
                    // value={formData.remark}
                    // onChange={(e) =>
...
export default CalibrationRacks;
