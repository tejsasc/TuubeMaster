...
const TTDTSRForm = (props) => {
  ...
  const getformData = function () {
    ...
    appendData(data, "qty_rack", formData.qtyRack);
  ...
  const sendData = async function (e) {
    ...
    if (props.data.isEdit) {
      url = `/part/tddtubesealrackretupddrl/${props.editId}/`;
      method = "PATCH";
    } else {
      url = "/part/tddtubesealrackcreate/";
      method = "POST";
    }
    ...
    if (response.status === 201) {
      dispatch(
        uiAction.setNotification({
          show: true,
          heading: "TTD TSR",
          msg: `TTD TSR ${formData.alternate_name} Added Successfully`,
        })
      );
      ...
      dispatch(
        uiAction.setNotification({
          show: true,
          heading: "TTD TSR",
          msg: `TTD TSR ${formData.alternate_name} Edited Successfully`,
        })
      );
      dispatchInputChange({ reset: true });
      props.refresh();
  ...
  const getAirHoseData = async function () {
    ...
    const response = await ajaxCall(
      `/part/tddtubesealrackretupddrl/${props.editId}/`,
      {
        headers: {
    ...
    dispatchInputChange({
      ...
      data: {
        ...
        qtyRack: response.data?.qty_rack,
    ...
    <>
            ...
            {props.data.isEdit && isLoading ? (
              ...
              <Form onSubmit={showPrompt}>
                ...
                >
                  ...
                  <Tab eventKey={1} title="TTD TSR Info">
                    <div className="row">
                      <Form.Group
                        className="mb-3 col-md-6"
                ...
                <div className="col-md-12 flexCenter gap10">
                  ...
                  {props.data.isEdit ? (
                    <Link to="/tdd-tsr" className="btn btn-secondary">
                      Cancel Edit
                    </Link>
                  ) : (
                    ""
      ...
      {isShowPopup ? (
        <EquipPartModal
          ...
          title="Want to Save TTD Tube Seal Rack ?"
          body={
            <div className="row">
              ...
              <div className="col-md-6 grid3Auto rowGap20">
                ...
                <span>Qty rack</span>:<span>{formData?.qtyRack}</span>
              </div>
