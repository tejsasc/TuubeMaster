...
const BDDTSRForm = (props) => {
  ...
  const getformData = function () {
    ...
    appendData(data, "number_of_tubes", formData.numberOfTubes);
    return data;
  };
  ...
  const sendData = async function (e) {
    ...
    if (props.data.isEdit) {
      url = `/part/bddtubesealrackretupddrl/${props.editId}/`;
      method = "PATCH";
    } else {
      url = "/part/bddtubesealrackcreate/";
      method = "POST";
    }
    ...
    if (response.status === 201) {
      dispatch(
        uiAction.setNotification({
          show: true,
          heading: "BDD Tube Seal Rack",
          msg: `BDD Tube Seal Rack ${formData.alternate_name} Added Successfully`,
        })
      );
      ...
      dispatch(
        uiAction.setNotification({
          show: true,
          heading: "BDD Tube Seal Rack",
          msg: `BDD Tube Seal Rack ${formData.alternate_name} Edited Successfully`,
        })
      );
      dispatchInputChange({ reset: true });
      props.refresh();
  ...
  const getAirHoseData = async function () {
    ...
    const response = await ajaxCall(
      `/part/bddtubesealrackretupddrl/${props.editId}/`,
      {
        headers: {
    ...
    dispatchInputChange({
      ...
      data: {
        ...
        numberOfTubes: response.data?.number_of_tubes,
      },
    });
            ...
            {props.data.isEdit && isLoading ? (
              ...
              <Form onSubmit={showPrompt}>
                ...
                >
                  ...
                  <Tab eventKey={1} title="BDD TSR Info">
                    <div className="row">
                      <Form.Group
                        className="mb-3 col-md-6"
                ...
                <div className="col-md-12 flexCenter gap10">
                  ...
                  {props.data.isEdit ? (
                    <Link to="/bdd-tsr" className="btn btn-secondary">
                      Cancel Edit
                    </Link>
                  ) : (
                    ""
          ...
          body={
            <div className="row">
              ...
              <div className="col-md-6 grid3Auto rowGap20">
                ...
                <span>{formData?.numberOfTubes}</span>
              </div>
