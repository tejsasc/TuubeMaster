...
const SMTSRForm = (props) => {
  ...
  const getformData = function () {
    ...
    appendData(data, "qty_rack", formData.qty_rack);
    appendData(data, "tube_seal_rack", formData.tubeSealRack);
    return data;
  };
  ...
  const sendData = async function (e) {
    ...
    if (props.data.isEdit) {
      url = `/part/swabmastertsrretupddrl/${props.editId}/`;
      method = "PATCH";
    } else {
      url = "/part/swabmastertsrcreate/";
      method = "POST";
    }
    ...
    if (response.status === 201) {
      dispatch(
        uiAction.setNotification({
          show: true,
          heading: "SwabMaster TSR",
          msg: `SwabMaster TSR ${formData.alternate_name} Added Successfully`,
        })
      );
      ...
      dispatch(
        uiAction.setNotification({
          show: true,
          heading: "SwabMaster TSR",
          msg: `SwabMaster TSR ${formData.alternate_name} Edited Successfully`,
        })
      );
      dispatchInputChange({ reset: true });
      props.refresh();
  ...
  const getAirHoseData = async function () {
    ...
    const response = await ajaxCall(
      `/part/swabmastertsrretupddrl/${props.editId}/`,
      {
        headers: {
    ...
    dispatchInputChange({
      ...
      data: {
        ...
        qty_rack: response.data?.qty_rack,
        tubeSealRack: response.data?.tube_seal_rack,
      },
    });
    ...
    <>
            ...
            {props.data.isEdit && isLoading ? (
              ...
              <Form onSubmit={showPrompt}>
                ...
                >
                  ...
                  <Tab eventKey={1} title="SwabMaster TSR Info">
                    <div className="row">
                      <Form.Group
                        className="mb-3 col-md-6"
                  ...
                  <Tab eventKey={2} title="Specification">
                    <div className="row">
                      ...
                      <Form.Group
                        ...
                        controlId="formGroupRemark"
                      >
                        <Form.Label>Qty rack</Form.Label>
                        <Form.Control
                          type="text"
                          value={formData.qty_rack}
                          onChange={(e) =>
                            dispatchInputChange({
                              type: "qty_rack",
                              value: e.target.value,
                      ...
                      <Form.Group
                        ...
                        controlId="formGroupRemark"
                      >
                        <Form.Label>Tube seal rack</Form.Label>
                        <Form.Control
                          type="text"
                          value={formData.tubeSealRack}
                          onChange={(e) =>
                            dispatchInputChange({
                              type: "tubeSealRack",
                              value: e.target.value,
                ...
                <div className="col-md-12 flexCenter gap10">
                  ...
                  {props.data.isEdit ? (
                    <Link to="/sm-tsr" className="btn btn-secondary">
                      Cancel Edit
                    </Link>
                  ) : (
                    ""
      ...
      {isShowPopup ? (
        <EquipPartModal
          ...
          title="Want to Save SM Tube Seal Rack ?"
          body={
            <div className="row">
              <div className="col-md-6 grid3Auto rowGap20">
                ...
                <span>Tube seal rack</span>:
                <span>{formData?.tubeSealRack}</span>
              </div>
              <div className="col-md-6 grid3Auto rowGap20">
                ...
                <span>Quantity Rack</span>:<span>{formData?.qty_rack}</span>
              </div>
